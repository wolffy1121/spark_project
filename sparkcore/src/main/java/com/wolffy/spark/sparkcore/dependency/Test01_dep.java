package com.wolffy.spark.sparkcore.dependency;
...
public class Test01_dep {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaRDD<String> lineRDD = sc
                .textFile("./src/main/resources/input/1.txt", 4);

        JavaPairRDD<String, Integer> flatMapToPair = lineRDD
        ...
        JavaPairRDD<String, Integer> filter = flatMapToPair
        ...
        JavaPairRDD<String, Integer> reduceByKey = filter
